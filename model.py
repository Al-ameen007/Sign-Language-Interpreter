...
class SpatialGCNConv(nn.Module):
    def __init__(self, in_channels, out_channels, num_heads=4):
        super(SpatialGCNConv, self).__init__()
...
class GCNModelWithAttention(nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers=5, num_heads=4, dropout=0.0):
        super(GCNModelWithAttention, self).__init__()
...
def load_model(model_path, in_channels=3, hidden_channels=16, out_channels=20, 
               num_layers=5, num_heads=4, dropout=0.0, device='cpu'):
    model = create_model(
        in_channels=in_channels,
        hidden_channels=hidden_channels,
        out_channels=out_channels,
