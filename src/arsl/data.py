...
def create_graph_data_list(x_list, adj_matrices, labels, label_encoder):
    ...
    for x, adj_matrix, label in zip(x_list, adj_matrices, labels, strict=False):
...
def load_dataset(train_path="train_data.pth", test_path="test_data.pth", encoder_path="label_encoder.pkl"):
